...
<body>
        <div class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                    <form action="<?= base_url('admin/halaman/store'); ?>" method="POST">
                                <div class="form-grup">
                                ...
                                <div class="form-grup">
                                    ...
                                    <textarea name="isihalaman" class="form-control" id="isihalaman" placeholder="Masukkan Isi halaman"></textarea>
                                </div>
                                <div class="form-grup">

            ...
            <div class="row mt-3">
                <div class="col-sm-12">
                    <table class="table table-striped" id="tableuser">
                        ...
                        <tbody>
                            <?php if($halaman):?>
                            <?php foreach($halaman as $pengguna):?>
                            <tr>
                                <td><?= $pengguna['id'];?></td>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/halaman/edit/'.$pengguna['id']); ?>" class="btn btn-success">Edit</a>
                                    <a href="<?= base_url('admin/halaman/delete/'.$pengguna['id']); ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
